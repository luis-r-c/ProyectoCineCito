                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="Controlador?accion=Guardar" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label>Calidad</label>
                                    <input type="text" name="txtCalidad" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>Link</label>
                                ...
                                <div class="form-group">
                                    <button class="btn btn-danger" name="accion" value="Guardar">Guardar</button>
                                </div>
                            </form>
                        </div>               
                    </div>
                        ...
                        <tbody>
                            <c:forEach var="p" items="${peliculas}">
                                <tr class="text-center">
                                    ...
                                    <td>${p.getNombres()}
                                        <br>
                                        <img src="${p.getImagen()}" width="70" height="120">
                                    </td>
                                    <td>${p.getDescripcion()}</td>                                    
                                    <td>${p.getCalidad()}</td>
                                    <td>${p.getLink()}</td>
                                    <td class="d-flex">
                                        <a href="Controlador?accion=Cargar&id=${p.getId()}" class="btn btn-warning">Editar</a>
