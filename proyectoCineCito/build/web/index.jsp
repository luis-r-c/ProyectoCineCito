                ...
                <c:forEach var="p" items="${peliculas}">
                    <div class="col-sm-4">
                        <div class="form-group">
                            <div class="card">
                                <div class="card-header" style="color: #ffffff; background-color: darkslategray">
                                    <label class="col-sm-12">${p.getNombres()}</label>                                    
                                </div>
                                <div class="card-body text-center d-flex">
                                    <label>
                                        <i class="col-sm-12" style=" font-weight: bold ;color: yellow; background-color: black; border-radius: 4px ; border-color: yellow">${p.getCalidad()}</i>
                                    </label>
                                    <img src="${p.getImagen()}" width="200" height="300">
                                </div>
                                <div class="card-footer" style="color: #ffffff; background-color: darkslategray">
                                    <div class="col-sm-12">
                                        <label>${p.getDescripcion()}</label>                                   
                                    </div>
                                    <div class=" col-sm-12 text-center">                                
                                        <a href="${p.getLink()}" target="_blank" class="btn btn2 btn-outline-warning">Descargar <i class="fas fa-arrow-right"></i></a>
                                    </div>                         
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                ...
                                <div class="tab-pane fade" id="pills-registrar" role="tabpanel">
                                    <form action="Controlador">                               
                                        ...
                                        <div class="form-group">
                                            <label>Email</label>
                                            <input type="email" name="txtEmail" class="form-control" placeholder="email@gmail.com">
                                        </div>
                                        <div class="form-group">
                                            <label>Password</label>
                                            <input type="password" name="txtPass" class="form-control" placeholder="Password">
